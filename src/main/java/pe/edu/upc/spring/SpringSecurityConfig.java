	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		try {
			http.authorizeRequests()
					...
					.antMatchers("/distrito/modificar/**").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/distrito/eliminar/**").access("hasRole('ROLE_ADMIN')")
					...
					.antMatchers("/cancha/modificar/**").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/cancha/eliminar/**").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/cancha/irRegistrar").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/sede/irRegistrar").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/sede/modificar/**").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/sede/eliminar/**").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/persona/irBuscar").access("hasRole('ROLE_ADMIN')")
					.antMatchers("/reserva/irBuscar").access("hasRole('ROLE_ADMIN')")
					...
					.antMatchers("/persona/modificar/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
					.antMatchers("/persona/eliminar/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")					
